...
from prompts import GENERAL_PROMPT, ISSUES_PROMPT, REVIEW_PROMPT, REVIEW2_PROMPT
...
class ChatGPTLLM(LLMInterface):
    def __init__(self, debug: bool = False):
        ...
        if not api_key:
            raise ValueError(
                "OPENAI_API_KEY environment variable is required for ChatGPT"
            )
